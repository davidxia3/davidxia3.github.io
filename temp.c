...
<body>
    ...
    <hr>
    <h3>I am a big fan of Pokémon video games, trading card game, anime, and competitive battling. </h3>
    <h4>I reached top 300 on the Pokémon Showdown Gen 9 Random Battles ladder on September 28, 2025.</h4>
    ...
    <h3>Here are some pictures of myself that I like. </h3>
    <div class="image-row">
        ...
        <img src="misc/personal_pics/watertown.png" alt="personal 5">
        <img src="misc/personal_pics/jiufen.png" alt="personal 6">
    </div>

    <div class="image-row">
        <img src="misc/personal_pics/tongling.png" alt="personal 7">
        <img src="misc/personal_pics/mtsoledad2.png" alt="personal 8">
